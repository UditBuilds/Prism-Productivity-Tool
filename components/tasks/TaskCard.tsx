...
export function TaskCard({ task }: { task: Task }) {
  ...
  return (
    <div
      className={cn(
        "group cursor-default rounded-l-none rounded-r-xl border border-l-2 border-[#1F1F1F] bg-[#111111] p-4 hover:-translate-y-0.5 hover:border-[#2A2A2A] hover:shadow-lg hover:shadow-black/30 active:scale-[0.98] active:opacity-90",
